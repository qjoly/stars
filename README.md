...
- [rebound-how/rebound](https://github.com/rebound-how/rebound) - The open source toolbox for resilient operations
...
- [ddddddO/gtree](https://github.com/ddddddO/gtree) - Easily output ASCII tree from Go program or Markdown unordered list (and it does more than just output tree!). There's also CLI tool that can output tree from JSON, TOML, or YAML! It's called *xtree*.
...
- [devantler-tech/ksail](https://github.com/devantler-tech/ksail) - All-in-one Kubernetes SDK: create, manage, and operate clusters across distributions (Kind, K3d, Talos, VCluster) with built-in GitOps, secrets, AI assistant, and MCP server. Only requires Docker or a
...
- [BananaOps/scope](https://github.com/BananaOps/scope) - Syncronize Chart On Private Registry
...
- [helm-unittest/helm-unittest](https://github.com/helm-unittest/helm-unittest) - BDD styled unit test framework for Kubernetes Helm charts as a Helm plugin.
- [kdash-rs/kdash](https://github.com/kdash-rs/kdash) - A simple and fast dashboard for Kubernetes
- [meganokeefe/istiobyexample](https://github.com/meganokeefe/istiobyexample) - 
- [alex1989hu/kubelet-serving-cert-approver](https://github.com/alex1989hu/kubelet-serving-cert-approver) - Kubelet Serving TLS Certificate Signing Request Approver
...
- [Akanoa/Rustviz](https://github.com/Akanoa/Rustviz) - A visual way to learn rust and really understand what's going on at memory level
- [alexeldeib/inc-cli](https://github.com/alexeldeib/inc-cli) - CLI for interacting with incident.io for batch automation
...
- [Sn0wAlice/plex-youtube-provider](https://github.com/Sn0wAlice/plex-youtube-provider) - A Plex Custom Metadata Provider for YouTube channels archived with TubeSync.
- [imputnet/cobalt](https://github.com/imputnet/cobalt) - best way to save what you love
- [glanceapp/glance](https://github.com/glanceapp/glance) - A self-hosted dashboard that puts all your feeds in one place
